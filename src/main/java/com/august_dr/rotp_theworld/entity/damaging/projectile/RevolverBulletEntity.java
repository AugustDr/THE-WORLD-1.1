package com.august_dr.rotp_theworld.entity.damaging.projectile;
...
public class RevolverBulletEntity extends ModdedProjectileEntity {

    public RevolverBulletEntity(LivingEntity shooter, World world) {
        super(ModEntityTypes.TOMMY_GUN_BULLET.get(), shooter, world);
    }

    public RevolverBulletEntity(EntityType<? extends TommyGunBulletEntity> type, World world) {
        super(type, world);
    }
